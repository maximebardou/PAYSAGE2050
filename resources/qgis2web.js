...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [359276.830782, 6503519.220219, 450364.405539, 6570608.312166], maxZoom: 13, minZoom: 11
    })
});
...
map.getView().fit([359276.830782, 6503519.220219, 450364.405539, 6570608.312166], map.getSize());
